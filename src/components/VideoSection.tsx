  ...
  <section className="section-padding bg-background">
    <div className="max-w-5xl mx-auto">
      ...
      <motion.div
        ...
        className="relative aspect-video bg-card rounded-lg overflow-hidden border border-border glow-gold cursor-pointer group"
      >
        ...
        <div className="absolute bottom-6 left-6 text-sm text-muted-foreground">
          Video placeholder — embed your intro video here
        </div>
      </motion.div>
    </div>
  </section>
